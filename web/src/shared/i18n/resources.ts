  ...
  "zh-CN": {
    translation: {
      ...
      calls: {
        ...
        status: {
          incomingAudio: "{{name}} 邀请你语音通话",
          incomingVideo: "{{name}} 邀请你视频通话",
          ringing: "正在呼叫…",
          connecting: "正在连接…",
          active: "通话中",
          ended: "通话已结束",
  ...
  "en-US": {
    translation: {
      ...
      calls: {
        ...
        status: {
          incomingAudio: "{{name}} is inviting you to an audio call",
          incomingVideo: "{{name}} is inviting you to a video call",
          ringing: "Ringing…",
        ...
        errors: {
          ...
          busy: "The other person is already in a call.",
          offline: "The other person is offline.",
          network: "The call was interrupted by a network problem.",
        },
      },
      errors: {
