...
Open inbound UDP 49160-49200 for TURN relay traffic by default; if you change TURN_RELAY_MIN_PORT or TURN_RELAY_MAX_PORT, open the matching UDP range.
...
The coturn container renders coturn/turnserver.conf.template at startup so TURN_SHARED_SECRET, TURN_REALM, TURN_EXTERNAL_IP, TURN_RELAY_MIN_PORT, and TURN_RELAY_MAX_PORT are written into /tmp/turnserver.conf before turnserver starts.
